...
import 'package:flutter_firebase_alura/firestore/presentation/home_screen.dart';
import 'package:flutter_firebase_alura/firestore_produtos/helpers/enum_order.dart';
...
class _ProdutoScreenState extends State<ProdutoScreen> {
  ...
  OrdemProduto ordemProduto = OrdemProduto.name;
  bool isDescrescente = false;
      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton(
            ...
            onSelected: (value) {
              setState(() {
                if (ordemProduto == value) {
                  isDescrescente = !isDescrescente;
                } else {
                  ordemProduto = value;
                  isDescrescente = false;
                }
              });
              refresh();
            },
  ...
  refresh({QuerySnapshot<Map<String, dynamic>>? snapshot}) async {
    ...
    snapshot ??= await firestore
        ...
        .orderBy(ordemProduto.name, descending: isDescrescente)
        .get();
